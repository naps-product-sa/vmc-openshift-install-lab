...
If you've done everything correctly, the installer will output your console URL and `kubeadmin` credentials at the end of the log. Pop open the URL in your browser and login with the credentials provided.
